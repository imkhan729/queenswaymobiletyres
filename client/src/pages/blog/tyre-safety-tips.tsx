...
export default function TyreSafetyTips() {
  const schema = {
    ...
    "description": "Learn essential tyre safety tips including checking tread depth, pressure, and general condition to stay safe on the road with Queensway Mobile Tyres.",
    "mainEntityOfPage": {
      "@type": "WebPage",
