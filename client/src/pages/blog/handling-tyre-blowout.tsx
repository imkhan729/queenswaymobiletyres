...
export default function HandlingTyreBlowout() {
    const schema = {
        ...
        "@type": "BlogPosting",
        "headline": "Handling a Tyre Blowout on the Motorway: A Safety Guide",
        ...
        "description": "Essential safety guide on how to handle a high-speed tyre blowout on UK motorways. Stay safe and call Queensway Mobile Tyres for emergency support.",
        "mainEntityOfPage": {
            "@type": "WebPage",
    ...
    return (
        <div className="min-h-screen bg-background text-foreground">
            <SEO
                title="Tyre Blowout Safety Guide | Queensway Mobile Tyres"
                description="A tyre blowout can be terrifying. Follow these step-by-step safety instructions to handle a blowout on the motorway. 24/7 Emergency Service available."
                keywords="tyre blowout safety, motorway breakdown uk, emergency tyre change london, m25 tyre replacement, smart motorway safety tips, mobile tyre mechanic emergency"
                image={emergencyImage}
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-3xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-6 leading-tight">
                            Handling a Tyre Blowout on the Motorway: A Safety Guide
                        </h1>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="prose prose-invert prose-lg max-w-none text-gray-300">
                        <p className="text-xl leading-relaxed mb-8 font-medium text-white">
                            Experiencing a tyre blowout at 70mph is one of the most terrifying experiences a driver can face. The sudden loud bang, followed by a violent pull on the steering wheel, can induce panic. However, your immediate reaction in those first few seconds is critical. This guide by <strong className="text-primary">Queensway Mobile Tyres</strong> could save your life.
                        </p>
                        ...
                        <div className="bg-red-900/20 border border-red-500/50 p-6 rounded-xl mb-12 shadow-lg shadow-red-900/20">
                            ...
                            <p className="text-lg text-white">
                                <strong>NEVER attempt to change a tyre on the hard shoulder of a motorway.</strong> It is statistically one of the most dangerous places to be. Call a professional service like our <Link href="/emergency-call-out"><a className="text-primary hover:underline">emergency team</a></Link> with the correct safety equipment. For more rules on motorway breakdowns, consult the <a href="https://www.gov.uk/guidance/the-highway-code/breakdowns-and-incidents-274-to-287" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Highway Code (Rules 274-287)</a>.
                            </p>
                        </div>
                    </div>
                    ...
                    <p className="mb-6">
                        For fastest service, especially if you don't have cover, call <strong><Link href="/"><a className="text-primary hover:underline">Queensway Mobile Tyres</a></Link> Emergency Team</strong>. We act as a priority service for motorway call-outs.
                    </p>
                    ...
                    <div className="bg-primary/10 border border-primary/20 rounded-2xl p-8 text-center mt-12">
                        ...
                        <div className="flex flex-col gap-6 justify-center items-center">
                            <a href="tel:07427515915" className="inline-flex items-center gap-3 text-4xl md:text-5xl font-black text-primary hover:text-white transition-colors" onClick={() => (window as any).gtag?.('event', 'conversion', {'send_to': 'AW-17775313541/OJUeCK_Vh_wbEIWF95tC'})}>
