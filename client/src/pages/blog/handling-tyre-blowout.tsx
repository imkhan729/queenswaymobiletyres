                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-primary/10 border border-primary/20 rounded-2xl p-8 text-center mt-12">
                        ...
                        <div className="flex flex-col gap-6 justify-center items-center">
                            <a href="tel:07888888888" className="inline-flex items-center gap-3 text-4xl md:text-5xl font-black text-primary hover:text-white transition-colors">
                                <PhoneCall className="w-10 h-10 md:w-12 md:h-12" /> 078 888 8888
                            </a>
