...
export default function DecodingTyreMarkings() {
    const schema = {
        ...
        "description": "Learn how to read your tyre sidewall markings. Understand width, profile, rim size, load index, and speed rating with our expert breakdown.",
        "mainEntityOfPage": {
            "@type": "WebPage",
    ...
    return (
        <div className="min-h-screen bg-background text-foreground">
            <SEO
                title="Tyre Markings Explained | Queensway Mobile Tyres Blog"
                description="Confused by tyre numbers? Our guide explains what 205/55 R16 91V and other markings mean for your vehicle safety and performance."
                keywords="tyre markings explained, read tyre size, tyre load index chart, tyre speed rating guide, car tyre specification breakdown, Queensway tyre guide"
                image={tyreMarkingsImage}
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="prose prose-invert prose-lg max-w-none text-gray-300">
                        <p className="text-xl leading-relaxed mb-8 font-medium text-white">
                            When ordering new tyres from <Link href="/"><a className="text-primary hover:underline">Queensway Mobile Tyres</a></Link>, we ask for your tyre size. But looking at your sidewall can be like reading a secret code. That string of numbers and letters—e.g., <strong>205/55 R16 91V</strong>—contains vital engineering data about your vehicle's capabilities.
                        </p>
                        <p className="text-gray-300 mb-8">
                            Understanding these markings ensures you choose the correct tyre for your <Link href="/mobile-tyre-fitting"><a className="text-primary hover:underline">mobile tyre fitting</a></Link> appointment. For comprehensive safety data, organizations like <a href="https://www.tyresafe.org/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">TyreSafe</a> provide excellent resources.
                        </p>
