...
export default function WhenToReplaceTyres() {
  const schema = {
    ...
    "@type": "BlogPosting",
    "headline": "When Should You Replace Your Tyres? Legal Limits & Safety Guide",
    ...
    "description": "Unsure if your tyres need changing? Learn the legal 1.6mm tread depth limit, how to spot damage, and why the '20p test' could save your life.",
    "mainEntityOfPage": {
      "@type": "WebPage",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <SEO
        title="When to Replace Tyres? tread depth limit UK | Queensway Blog"
        description="Know the legal tyre tread depth in the UK (1.6mm). Learn the warning signs of worn tyres and how to perform the 20p test. Avoid fines and stay safe."
        keywords="when to replace car tyres, legal tyre tread depth uk, 20p tyre test, worn tyre signs, replacement tyres london, tyre safety law"
        image={replaceTyreImage}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-lg max-w-none text-gray-300">
            <p className="text-xl leading-relaxed mb-8 font-medium text-white">
              Knowing when to replace your tyres is not just about avoiding a hefty fine; it is the single most important maintenance task for your safety. At <strong className="text-primary">Queensway Mobile Tyres</strong>, we see hundreds of dangerous tyres every week. This guide explains exactly what to look for.
            </p>
            ...
            <p>
              This is why most experts, including <a href="https://www.rospa.com/road-safety/advice/vehicles/tyres" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">ROSPA</a> and our team, recommend <Link href="/booking"><a className="text-primary hover:underline">replacing tyres</a></Link> when they reach <strong>3mm</strong>. Performance drops off significantly after this point.
            </p>
