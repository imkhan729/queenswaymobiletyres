...
export default function MobileTyreFittingLondon() {
    const schema = {
        ...
        "@type": "BlogPosting",
        "headline": "Why Mobile Tyre Fitting is the Best Choice for Londoners",
        ...
        "publisher": {
            ...
            "logo": {
                "@type": "ImageObject",
                "url": "https://www.queenswaymobiletyres.co.uk/logo.png"
            }
        },
        "datePublished": "2024-01-10",
        "dateModified": "2024-03-15",
        "description": "Discover why mobile tyre fitting is the ultimate convenience for London drivers. Save time, money, and hassle with Queensway Mobile Tyres.",
        "mainEntityOfPage": {
            "@type": "WebPage",
    ...
    return (
        <div className="min-h-screen bg-background text-foreground">
            <SEO
                title="Best Mobile Tyre Fitting Service London | Queensway Mobile Tyres"
                description="Looking for mobile tyre fitting in London? Queensway Mobile Tyres brings the garage to your home or work. Expert, same-day service for all vehicle types. Book now!"
                keywords="mobile tyre fitting london, same day tyre fitting london, emergency mobile tyres london, 24 hour mobile tyre fitting, mobile tyre fitter near me, Queensway Mobile Tyres"
                image={mobileFittingImage}
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-3xl md:text-5xl lg:text-6xl font-heading font-bold text-white mb-6 leading-tight">
                            Why Mobile Tyre Fitting is the Best Choice for Londoners
                        </h1>
            ...
            <article className="py-16 container mx-auto px-4">
                <div className="max-w-4xl mx-auto">
                    <img
                        ...
                        alt="Queensway Mobile Tyre Fitting Van servicing a customer in London"
                    ...
                    <div className="prose prose-invert prose-lg max-w-none text-gray-300">
                        <p className="text-xl leading-relaxed mb-8 font-medium text-white">
                            Essential for the fast-paced London lifestyle, <strong><Link href="/mobile-tyre-fitting"><a className="text-primary hover:underline">mobile tyre fitting</a></Link></strong> is revolutionising how drivers maintain their vehicles. Gone are the days of wasting hours at a garage. With <strong className="text-primary"><Link href="/"><a className="text-primary hover:underline">Queensway Mobile Tyres</a></Link></strong>, expert technicians come directly to you—whether you're at home, at work, or stuck on the roadside.
                        </p>
                        ...
                        <p>
                            We are proud to serve the entire Greater London area. Whether you are in <strong><Link href="/locations/london"><a className="text-primary hover:underline">Central London</a></Link></strong>, <strong><Link href="/locations/london"><a className="text-primary hover:underline">North London</a></Link></strong>, <strong>West London</strong>, or the outskirts, our fleet is positioned to reach you fast.
                        </p>
                        ...
                        <div className="bg-primary/5 border border-primary/20 rounded-2xl p-8 my-12">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="border-t border-white/10 pt-4">
                                    ...
                                    <p className="text-gray-400">Absolutely. We adhere to <a href="https://www.tyresafe.org/tyre-safety/puncture-repairs/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">British Standard BSAU159</a>. If the puncture is in the safe repairable zone of the tread, we can <Link href="/puncture-repair"><a className="text-primary hover:underline">repair it on-site</a></Link> for a fraction of the cost of a new tyre.</p>
                                </div>
                                <div className="border-t border-white/10 pt-4">
