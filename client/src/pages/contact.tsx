          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <a href="tel:07427515915" className="text-2xl font-bold text-primary hover:text-white transition-colors block" onClick={() => { if (typeof window !== 'undefined' && window['gtag']) { window['gtag']('event', 'conversion', { 'send_to': 'AW-17775313541/OJUeCK_Vh_wbEIWF95tC', 'transaction_id': '' }); } }}>07427 515915</a>
