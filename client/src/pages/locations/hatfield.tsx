...
export default function HatfieldLocation() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground">
            <SEO
                title="Mobile Tyre Fitting Hatfield | 24/7 AL9 AL10 Tyre Service"
                description="Hatfield's fast mobile tyre service. We cover AL9 and AL10 postcodes, the A1(M) J3, and Hatfield Business Park. 24/7 emergency response from Hemel Hempstead."
                keywords="mobile tyre fitting hatfield, tyres hatfield, emergency tyre repair al9, mobile tyres al10, hatfield business park tyres, a1m j3 tyre breakdown"
                image={heroImage}
                schema={schema}
            />
            <Navbar />
            ...
            <div className="pt-24 pb-12 bg-secondary relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <h1 className="text-4xl md:text-6xl font-heading font-bold text-white mb-6">MOBILE TYRE FITTING <br /><span className="text-primary">HATFIELD</span></h1>
            ...
            <div className="py-16 container mx-auto px-4">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {[
                            { icon: Truck, label: "Mobile Tyre Fitting Hatfield", desc: "Same-day supply & fit in AL9, AL10 — home, driveway, or business park.", href: "/mobile-tyre-fitting" },
                            { icon: Clock, label: "24/7 Emergency Call-Out Hatfield", desc: "Breakdown on the A1(M) J3? We respond day or night, 365 days a year.", href: "/emergency-call-out" },
                            { icon: Wrench, label: "Puncture Repair Hatfield", desc: "BS AU 159 standard permanent repairs — done at your location in 20–30 minutes.", href: "/puncture-repair" },
                            { icon: Settings, label: "Wheel Balancing Hatfield", desc: "Digital precision balancing included with every new tyre — no garage trip needed.", href: "/wheel-balancing" },
                            { icon: Battery, label: "Battery Replacement Hatfield", desc: "Dead battery in AL9 or AL10? We supply and fit AGM, EFB & standard batteries on-site.", href: "/battery-replacement" },
                            { icon: Lock, label: "Locking Nut Removal Hatfield", desc: "Lost your locking wheel nut key in Hatfield? Safe removal — no alloy damage guaranteed.", href: "/locking-nut-removal" },
                        ].map(s => (
                ...
                <div className="mb-12 border-t border-white/10 pt-8">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <Link href="/locations/welwyn-garden-city" className="text-primary hover:text-white hover:underline text-sm font-bold">Mobile Tyres Welwyn Garden City</Link>
                ...
                <div className="bg-primary/10 border border-primary/20 rounded-2xl p-8 text-center max-w-3xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="tel:07427515915" onClick={() => { if (typeof window !== 'undefined' && window['gtag']) { window['gtag']('event', 'conversion', { 'send_to': 'AW-17775313541/OJUeCK_Vh_wbEIWF95tC', 'transaction_id': '' }); } }}><Button size="lg" className="bg-primary text-black font-bold uppercase hover:bg-primary/90 w-full sm:w-auto"><Phone className="mr-2 w-5 h-5" />Call 07427 515915</Button></a>
