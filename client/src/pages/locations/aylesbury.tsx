...
export default function AylesburyLocation() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground">
            <SEO
                title="Mobile Tyre Fitting Aylesbury | 24/7 HP Postcodes Tyres"
                description="Aylesbury's trusted mobile tyre service. We come to your home, work, or roadside across HP17–HP22. Fast response on the A41 and A418 from our Hemel Hempstead base."
                keywords="mobile tyre fitting aylesbury, tyres aylesbury, emergency tyre repair aylesbury, mobile tyres hp postcodes, aylesbury vale tyres, a41 tyre breakdown"
                image={heroImage}
                schema={schema}
            />
            <Navbar />
            ...
            <div className="pt-24 pb-12 bg-secondary relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <h1 className="text-4xl md:text-6xl font-heading font-bold text-white mb-6">MOBILE TYRE FITTING <br /><span className="text-primary">AYLESBURY</span></h1>
            ...
            <div className="py-16 container mx-auto px-4">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {[
                            { icon: Truck, label: "Mobile Tyre Fitting Aylesbury", desc: "Same-day supply & fit across all HP postcodes — home, work, or roadside.", href: "/mobile-tyre-fitting" },
                            { icon: Clock, label: "24/7 Emergency Call-Out Aylesbury", desc: "Breakdown on the A41 or A418 near Aylesbury? We respond day or night.", href: "/emergency-call-out" },
                            { icon: Wrench, label: "Puncture Repair Aylesbury", desc: "BS AU 159 compliant permanent repairs at your Aylesbury location.", href: "/puncture-repair" },
                            { icon: Settings, label: "Wheel Balancing Aylesbury", desc: "Digital precision balancing — eliminates vibration, extends tyre life.", href: "/wheel-balancing" },
                            { icon: Battery, label: "Battery Replacement Aylesbury", desc: "Dead battery in Aylesbury? We supply and fit AGM, EFB & standard batteries.", href: "/battery-replacement" },
                            { icon: Lock, label: "Locking Nut Removal Aylesbury", desc: "Lost your locking wheel nut key? Safe specialist removal at your door.", href: "/locking-nut-removal" },
                        ].map(s => (
                ...
                <div className="mb-12 border-t border-white/10 pt-8">
                    ...
                    <div className="flex flex-wrap gap-3">
                        ...
                        <Link href="/locations/high-wycombe" className="text-primary hover:text-white hover:underline text-sm font-bold">Mobile Tyres High Wycombe</Link>
                        <span className="text-gray-600">|</span>
