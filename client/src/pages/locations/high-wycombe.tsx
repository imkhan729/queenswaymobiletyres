...
export default function HighWycombeLocation() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground">
            <SEO
                title="Mobile Tyre Fitting High Wycombe | 24/7 M40 Tyres HP10–HP15"
                description="High Wycombe's trusted mobile tyre service. We cover HP10–HP15 and the M40 J4 corridor. Fast response from our Hemel Hempstead base — home, work, or roadside."
                keywords="mobile tyre fitting high wycombe, tyres high wycombe, emergency tyre repair m40, mobile tyres hp10, wycombe tyre service, m40 j4 breakdown tyres"
                image={heroImage}
                schema={schema}
            />
            <Navbar />
            ...
            <div className="pt-24 pb-12 bg-secondary relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <h1 className="text-4xl md:text-6xl font-heading font-bold text-white mb-6">MOBILE TYRE FITTING <br /><span className="text-primary">HIGH WYCOMBE</span></h1>
            ...
            <div className="py-16 container mx-auto px-4">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {[
                            { icon: Truck, label: "Mobile Tyre Fitting High Wycombe", desc: "Same-day supply & fit across all HP10–HP15 postcodes — home or work.", href: "/mobile-tyre-fitting" },
                            { icon: Clock, label: "24/7 Emergency Call-Out High Wycombe", desc: "Blowout on the M40 J4 or A40? We dispatch immediately, day or night.", href: "/emergency-call-out" },
                            { icon: Wrench, label: "Puncture Repair High Wycombe", desc: "BS AU 159 compliant permanent repairs — faster and often cheaper than a full replacement.", href: "/puncture-repair" },
                            { icon: Settings, label: "Wheel Balancing High Wycombe", desc: "Digital precision balancing at your door — stops vibration, extends tyre life.", href: "/wheel-balancing" },
                            { icon: Battery, label: "Battery Replacement High Wycombe", desc: "Dead battery in HP postcodes? We supply and fit AGM, EFB & standard batteries.", href: "/battery-replacement" },
                            { icon: Lock, label: "Locking Nut Removal High Wycombe", desc: "Lost your locking wheel nut key? Specialist removal — no alloy damage.", href: "/locking-nut-removal" },
                        ].map(s => (
