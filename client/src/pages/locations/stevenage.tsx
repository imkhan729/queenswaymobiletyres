            ...
            <div className="py-16 container mx-auto px-4">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {[
                            { icon: Truck, label: "Mobile Tyre Fitting Stevenage", desc: "Same-day supply & fit in SG1, SG2 and all Stevenage postcodes.", href: "/mobile-tyre-fitting" },
                            { icon: Clock, label: "24/7 Emergency Call-Out Stevenage", desc: "Breakdown on the A1(M) near Stevenage? We respond 24/7.", href: "/emergency-call-out" },
                            { icon: Wrench, label: "Puncture Repair Stevenage", desc: "BS AU 159 compliant permanent repairs at your home or roadside.", href: "/puncture-repair" },
                            { icon: Settings, label: "Wheel Balancing Stevenage", desc: "Precision digital balancing — no more steering wheel vibration.", href: "/wheel-balancing" },
                            { icon: Battery, label: "Battery Replacement Stevenage", desc: "Dead battery in SG1 or SG2? We supply and fit on-site.", href: "/battery-replacement" },
                            { icon: Lock, label: "Locking Nut Removal Stevenage", desc: "Lost your locking key in Stevenage? Safe specialist removal.", href: "/locking-nut-removal" },
                        ].map(s => (
                    ...
                    <div className="space-y-5">
                        {[
                            ...
                            },
                            {
                                ...
                                a: "We cover SG1 (Stevenage town centre, Bedwell, Broadwater), SG2 (Shephall, Chells, Pin Green), and also extend to SG3 (Knebworth), SG4 (Hitchin), and SG6 (Letchworth) within our 40-mile radius."
                            },
                            {
