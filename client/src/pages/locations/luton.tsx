            ...
            <div className="py-16 container mx-auto px-4">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {[
                            { icon: Truck, label: "Mobile Tyre Fitting Luton", desc: "Same-day supply & fit at your home, work or roadside in all LU postcodes.", href: "/mobile-tyre-fitting" },
                            { icon: Clock, label: "24/7 Emergency Call-Out Luton", desc: "Blowout on the M1 or A505? We reach you fast day or night.", href: "/emergency-call-out" },
                            { icon: Wrench, label: "Puncture Repair Luton", desc: "BS AU 159 compliant permanent repairs — save money on a new tyre.", href: "/puncture-repair" },
                            { icon: Settings, label: "Wheel Balancing Luton", desc: "Digital balancing at your driveway — included with every new tyre.", href: "/wheel-balancing" },
                            { icon: Battery, label: "Battery Replacement Luton", desc: "AGM, EFB & standard batteries supply and fit at your location.", href: "/battery-replacement" },
                            { icon: Fuel, label: "Emergency Fuel Delivery Luton", desc: "Petrol or diesel delivered to you — great for Luton Airport area.", href: "/emergency-fuel" },
                            { icon: Lock, label: "Locking Nut Removal Luton", desc: "Lost your key? Our specialist tools remove nuts without alloy damage.", href: "/locking-nut-removal" },
                        ].map(s => (
