...
export default function WelwynGardenCityLocation() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground">
            <SEO
                title="Mobile Tyre Fitting Welwyn Garden City | 24/7 AL7 AL8 Tyres"
                description="Welwyn Garden City's trusted mobile tyre service. We cover AL7 and AL8 postcodes and the A1(M) J4 area. Fast response — home, work, or roadside."
                keywords="mobile tyre fitting welwyn garden city, tyres welwyn garden city, emergency tyre repair al7, mobile tyres al8, welwyn tyre service, a1m j4 tyre breakdown"
                image={heroImage}
                schema={schema}
            />
            <Navbar />
            ...
            <div className="py-16 container mx-auto px-4">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {[
                            { icon: Truck, label: "Mobile Tyre Fitting Welwyn Garden City", desc: "Same-day supply & fit in AL7, AL8 — home, driveway, or office car park.", href: "/mobile-tyre-fitting" },
                            { icon: Clock, label: "24/7 Emergency Call-Out WGC", desc: "Breakdown on the A1(M) J4? We respond around the clock, all year.", href: "/emergency-call-out" },
                            { icon: Wrench, label: "Puncture Repair Welwyn Garden City", desc: "BS AU 159 permanent repairs at your location — home or roadside.", href: "/puncture-repair" },
                            { icon: Settings, label: "Wheel Balancing Welwyn Garden City", desc: "Digital precision balancing — done at your door, no garage visit needed.", href: "/wheel-balancing" },
                            { icon: Battery, label: "Battery Replacement WGC", desc: "Dead battery in AL7 or AL8? We supply & fit on-site, including AGM and EFB.", href: "/battery-replacement" },
                            { icon: Lock, label: "Locking Nut Removal Welwyn Garden City", desc: "Lost your locking key in WGC? Safe specialist removal without alloy damage.", href: "/locking-nut-removal" },
                        ].map(s => (
