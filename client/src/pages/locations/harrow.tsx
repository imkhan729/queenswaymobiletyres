            ...
            <div className="py-16 container mx-auto px-4">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {[
                            { icon: Truck, label: "Mobile Tyre Fitting Harrow", desc: "Same-day supply & fit in HA1, HA2, HA3 and all Harrow postcodes.", href: "/mobile-tyre-fitting" },
                            { icon: Clock, label: "24/7 Emergency Call-Out Harrow", desc: "Rapid roadside response in Harrow and North West London.", href: "/emergency-call-out" },
                            { icon: Wrench, label: "Puncture Repair Harrow", desc: "BS AU 159 compliant repairs at your location. Cheaper than a new tyre.", href: "/puncture-repair" },
                            { icon: Settings, label: "Wheel Balancing Harrow", desc: "Stop the steering wheel vibration. Digital balancing at your door.", href: "/wheel-balancing" },
                            { icon: Battery, label: "Battery Replacement Harrow", desc: "Dead battery? We supply and fit at your Harrow location.", href: "/battery-replacement" },
                            { icon: Lock, label: "Locking Nut Removal Harrow", desc: "Lost your locking key? Specialist removal without alloy damage.", href: "/locking-nut-removal" },
                        ].map(s => (
