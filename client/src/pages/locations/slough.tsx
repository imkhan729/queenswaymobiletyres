...
export default function SloughLocation() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground">
            <SEO title="Mobile Tyre Fitting Slough | M4 Emergency Tyres" description="Expert mobile tyre fitting in Slough, Langley, and Burnham. Fast M4 roadside assistance. 24/7 emergency service." keywords="mobile tyre fitting slough, tyres m4, emergency tyre repair slough, mobile tyres langley" image={heroImage} schema={schema} />
            <Navbar />
            <div className="pt-24 pb-12 bg-secondary relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <h1 className="text-4xl md:text-6xl font-heading font-bold text-white mb-6">MOBILE TYRE FITTING <br /><span className="text-primary">SLOUGH</span></h1>
            ...
            <div className="py-16 container mx-auto px-4">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {[
                            { icon: Truck, label: "Mobile Tyre Fitting Slough", desc: "Supply & fit in SL1, SL2, SL3 and all Slough postcodes — home, work or M4 roadside.", href: "/mobile-tyre-fitting" },
                            { icon: Clock, label: "24/7 Emergency Call-Out Slough", desc: "Breakdown on the M4? Our team responds day and night.", href: "/emergency-call-out" },
                            { icon: Wrench, label: "Puncture Repair Slough", desc: "BS AU 159 compliant permanent repairs at your location.", href: "/puncture-repair" },
                            { icon: Settings, label: "Wheel Balancing Slough", desc: "Digital computerised balancing — included with every tyre fit.", href: "/wheel-balancing" },
                            { icon: Battery, label: "Battery Replacement Slough", desc: "Car won't start? We supply and fit the right battery on-site.", href: "/battery-replacement" },
                            { icon: Lock, label: "Locking Nut Removal Slough", desc: "Specialist removal without damage to your alloy wheels.", href: "/locking-nut-removal" },
                        ].map(s => (
                ...
                <div className="bg-primary/10 border border-primary/20 rounded-2xl p-8 text-center max-w-3xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="tel:07427515915" onClick={() => (window as any).gtag?.('event', 'conversion', {'send_to': 'AW-17775313541/OJUeCK_Vh_wbEIWF95tC'})}><Button size="lg" className="bg-primary text-black font-bold uppercase hover:bg-primary/90 w-full sm:w-auto">Call 07427 515915</Button></a>
