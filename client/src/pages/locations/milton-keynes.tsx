            ...
            <div className="py-16 container mx-auto px-4">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {[
                            { icon: Truck, label: "Mobile Tyre Fitting Milton Keynes", desc: "Same-day supply & fit across all MK postcodes — home, work, or grid road breakdown.", href: "/mobile-tyre-fitting" },
                            { icon: Clock, label: "24/7 Emergency Call-Out MK", desc: "Blowout on the M1 J13–14 or A5? We dispatch immediately, day or night.", href: "/emergency-call-out" },
                            { icon: Wrench, label: "Puncture Repair Milton Keynes", desc: "BS AU 159 standard permanent repairs — often cheaper than a full replacement.", href: "/puncture-repair" },
                            { icon: Settings, label: "Wheel Balancing Milton Keynes", desc: "Digital balancing included with every fitting — we come to your driveway.", href: "/wheel-balancing" },
                            { icon: Battery, label: "Battery Replacement Milton Keynes", desc: "Dead battery in MK? We supply and fit AGM, EFB, and standard batteries.", href: "/battery-replacement" },
                            { icon: Fuel, label: "Emergency Fuel Delivery MK", desc: "Run dry near Milton Keynes? We deliver petrol or diesel to your location.", href: "/emergency-fuel" },
                            { icon: Lock, label: "Locking Nut Removal Milton Keynes", desc: "Lost your locking wheel nut key? Safe specialist removal at your door.", href: "/locking-nut-removal" },
                        ].map(s => (
