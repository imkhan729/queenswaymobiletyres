        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-12 mb-12">
          ...
          <div className="lg:col-span-1.5">
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/mobile-tyre-fitting"><a className="text-gray-400 hover:text-primary transition-colors">Mobile Fitting</a></Link></li>
              <li><Link href="/emergency-call-out"><a className="text-gray-400 hover:text-primary transition-colors">Emergency</a></Link></li>
          ...
          <div className="lg:col-span-1.5">
            ...
            <ul className="space-y-3">
              <li><Link href="/mobile-tyre-fitting"><a className="text-gray-400 hover:text-primary transition-colors">Tyre Fitting</a></Link></li>
              <li><Link href="/puncture-repair"><a className="text-gray-400 hover:text-primary transition-colors">Puncture repair</a></Link></li>
              <li><Link href="/emergency-call-out"><a className="text-gray-400 hover:text-primary transition-colors">Roadside</a></Link></li>
              <li><Link href="/battery-replacement"><a className="text-gray-400 hover:text-primary transition-colors">Batteries</a></Link></li>
              <li><Link href="/wheel-balancing"><a className="text-gray-400 hover:text-primary transition-colors">Balancing</a></Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3 lg:pl-4">
            ...
            <ul className="two-column-list text-sm">
              ...
              <li><Link href="/locations/london"><a className="text-gray-400 hover:text-primary transition-colors">London</a></Link></li>
              <li><Link href="/locations/hemel-hempstead"><a className="text-gray-400 hover:text-primary transition-colors">Hemel</a></Link></li>
            </ul>
          </div>
        </div>
