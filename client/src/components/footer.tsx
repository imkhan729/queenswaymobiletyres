      ...
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400">Serving London, Hertfordshire, Bedfordshire & M25 Corridor</span>
              </li>
              <li>
                <a href="tel:07988018865" className="flex items-center gap-3 text-gray-400 hover:text-primary transition-colors group">
                  ...
                  <span className="font-bold text-white text-lg">07988 018865</span>
                </a>
              </li>
              <li>
                <a href="https://wa.me/447988018865" className="flex items-center gap-3 text-gray-400 hover:text-green-500 transition-colors">
              ...
              <li>
                <a href="mailto:info@queenswaymobiletyres.com" className="flex items-center gap-3 text-gray-400 hover:text-primary transition-colors">
                  <Mail className="w-5 h-5 text-primary" />
                  <span>info@queenswaymobiletyres.com</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          ...
          <div className="flex gap-6 mt-4 md:mt-0">
            ...
            <Link href="/sitemap.xml"><a className="hover:text-primary transition-colors">Sitemap</a></Link>
          </div>
        </div>
      </div>
    </footer>
