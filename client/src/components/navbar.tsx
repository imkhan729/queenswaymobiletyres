    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          <a href="tel:07427515915" className="group" onClick={() => (window as any).gtag?.('event', 'conversion', {'send_to': 'AW-17775313541/OJUeCK_Vh_wbEIWF95tC'})}>
            ...
            <SheetContent className="bg-background border-l border-white/10 overflow-y-auto">
              <div className="flex flex-col gap-6 mt-10">
                ...
                <div className="flex flex-col gap-3 mt-4">
                  <a href="tel:07427515915" className="w-full" onClick={() => (window as any).gtag?.('event', 'conversion', {'send_to': 'AW-17775313541/OJUeCK_Vh_wbEIWF95tC'})}>
